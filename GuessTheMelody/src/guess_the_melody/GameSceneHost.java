...
public class GameSceneHost extends JFrame{
	...
	public GameSceneHost(String userName) {

		setTitle(userName.toString() + "님의 방");
		setSize(640, 720);
		setResizable(false);
	...
	class ServerThread extends Thread {
		...
		public void run() {
			...
			try {
				...
				ta.append(opponentName + "님이 입장하셨습니다! (" + socket.getInetAddress().getHostAddress() + ")\n");
				me.state = gameState.attack;
				ta.append(me.name + " 님의 차례입니다.\n");
